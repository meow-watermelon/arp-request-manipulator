...
import argparse
import os
from scapy.all import Ether,ARP,get_working_ifaces,raw,sendp
import sys
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interface', type=str, required=True, help='Interface to send ARP requests (interfaces: %s)' %(display_interfaces_info()))
    ...
    if not arp_request:
        ...
        sendp(arp_request, iface=args.interface, count=args.count, inter=1)
